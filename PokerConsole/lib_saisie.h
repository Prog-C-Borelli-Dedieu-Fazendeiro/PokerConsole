 ...
 * \brief fonction de saisie d'une chaine de caractère de longueur maximale donnée si l'utilisateur dépasse on l'avertit et il doit resaisir
 *
 * \param char * const psChaine Pointeur vers une chaine de caractère : adresse a remplir avec la chaine saisie par l'utilisateur.
